(function() {
  ...
  var verticeTriangle = new Float32Array([
    //x,y,z           //r,g,b
      +0.0, -0.5, +0.0,                   1.0, 1.0, 0.0,  // kuning
      +0.0, +0.5, +0.0,                   1.0, 1.0, 0.0,  // kuning
      +0.1, +0.5, +0.0,/*segitiga1*/      1.0, 1.0, 0.0,  // kuning
      +0.0, -0.5, +0.0,                   1.0, 1.0, 0.0,  // kuning
      +0.1, +0.5, +0.0,                   1.0, 1.0, 0.0,  // kuning
      +0.1, -0.5, +0.0,/*segitiga2*/      1.0, 1.0, 0.0,  // kuning
      +0.1, +0.3, +0.0,                   1.0, 1.0, 0.0,  // kuning
      +0.1, +0.5, +0.0,                   1.0, 1.0, 0.0,  // kuning
      +0.3, +0.3, +0.0,/*segitiga3*/      1.0, 1.0, 0.0,  // kuning
      +0.1, +0.5, +0.0,                   1.0, 1.0, 0.0,  // kuning
      +0.3, +0.5, +0.0,                   1.0, 1.0, 0.0,  // kuning
      +0.3, +0.3, +0.0,/*segitiga4*/      1.0, 1.0, 0.0,  // kuning
      +0.3, +0.5, +0.0,                   1.0, 1.0, 0.0,  // kuning
      +0.3, +0.3, +0.0,                   1.0, 1.0, 0.0,  // kuning
      +0.4, +0.3, +0.0,/*segitiga5*/      1.0, 1.0, 0.0,  // kuning
      +0.3, +0.3, +0.0,                   1.0, 1.0, 0.0,  // kuning
      +0.3, -0.3, +0.0,                   1.0, 1.0, 0.0,  // kuning
      +0.4, -0.3, +0.0,/*segitiga6*/      1.0, 1.0, 0.0,  // kuning
      +0.3, +0.3, +0.0,                   1.0, 1.0, 0.0,  // kuning
      +0.4, +0.3, +0.0,                   1.0, 1.0, 0.0,  // kuning
      +0.4, -0.3, +0.0,/*segitiga7*/      1.0, 1.0, 0.0,  // kuning
      +0.3, -0.3, +0.0,                   1.0, 1.0, 0.0,  // kuning
      +0.4, -0.3, +0.0,                   1.0, 1.0, 0.0,  // kuning
      +0.3, -0.5, +0.0,/*segitiga8*/      1.0, 1.0, 0.0,  // kuning
      +0.3, -0.3, +0.0,                   1.0, 1.0, 0.0,  // kuning
      +0.1, -0.3, +0.0,                   1.0, 1.0, 0.0,  // kuning
      +0.1, -0.5, +0.0,/*segitiga9*/      1.0, 1.0, 0.0,  // kuning
      +0.3, -0.3, +0.0,                   1.0, 1.0, 0.0,  // kuning
      +0.3, -0.5, +0.0,                   1.0, 1.0, 0.0,  // kuning
      +0.1, -0.5, +0.0,                   1.0, 1.0, 0.0  // kuning
  ]);
  ...
  function draw(){
    ...
    ac = glMatrix.vec3.fromValues(0.17, 0.40, 0.80);//nrp 05111740000080
